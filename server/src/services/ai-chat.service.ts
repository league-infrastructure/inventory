...
function getToolDefinitions(): ToolDef[] {
  return [
    ...
    { name: 'create_computer', description: 'Create a new computer', input_schema: { type: 'object', properties: { serialNumber: { type: 'string' }, serviceTag: { type: 'string' }, model: { type: 'string' }, adminUsername: { type: 'string' }, adminPassword: { type: 'string' }, disposition: { type: 'string' }, notes: { type: 'string' }, siteId: { type: 'number' }, kitId: { type: 'number' }, hostNameId: { type: 'number' } }, required: [] }, requiresQM: true },
    { name: 'update_computer', description: 'Update an existing computer', input_schema: { type: 'object', properties: { id: { type: 'number' }, serialNumber: { type: 'string' }, serviceTag: { type: 'string' }, model: { type: 'string' }, adminUsername: { type: 'string' }, adminPassword: { type: 'string' }, disposition: { type: 'string' }, notes: { type: 'string' }, siteId: { type: 'number' }, kitId: { type: 'number' }, hostNameId: { type: 'number' } }, required: ['id'] }, requiresQM: true },

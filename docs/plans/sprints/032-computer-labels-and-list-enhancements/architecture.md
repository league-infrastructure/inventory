...
> Label module with a new 89mm × 28mm computer label format, adds batch
> computer label printing, adds checkbox selection and "Last Updated"
> column to the computer list UI.

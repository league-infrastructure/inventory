...
1. Add `https://inventory.jtlapp.net/api/auth/google/callback` as an
   authorized redirect URI in Google Cloud Console
2. Add `https://inventory.jtlapp.net` as an authorized JavaScript origin
...
- [ ] Google OAuth login works at https://inventory.jtlapp.net
- [ ] User can browse kits and view images after login
- [ ] QR codes contain `https://inventory.jtlapp.net/qr/...` URLs

...
- [ ] `config/prod/secrets.env` is SOPS-encrypted with all required values
- [ ] Swarm secrets are created on swarm1
- [ ] `DOCKER_CONTEXT=swarm1 docker secret ls` shows all expected secrets
